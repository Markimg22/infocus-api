...
import { AuthenticationUserSpy, CreateUserSpy, ValidationSpy } from '@/tests/presentation/mocks'
...
const makeSut = (): SutTypes => {
  ...
  const sut = new SignUpController(validationSpy, createUserSpy, authenticationUserSpy)
  return {
    sut,
    validationSpy,
    createUserSpy,
